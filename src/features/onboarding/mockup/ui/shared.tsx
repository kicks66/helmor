...
import kmorLogo from "@/assets/kmor-logo-light.png";
import {
	Avatar,
	AvatarBadge,
	AvatarFallback,
...
// ─── Avatar (Kmor logo, mockup-private) ─────────────────────────────────
// All mockup rows show the Kmor logo — this is a marketing/onboarding
...
export function WorkspaceAvatarUI({
	...
	return (
		...
		>
			<AvatarImage src={kmorLogo} alt="" className="object-contain" />
			<AvatarFallback
				delayMs={0}
				className={cn(
